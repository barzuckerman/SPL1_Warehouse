...
Skeleton: bin/Customer.o bin/Order.o bin/Volunteer.o bin/Action.o bin/WareHouse.o bin/main.o
	g++ -o bin/warehouse bin/Customer.o bin/Order.o bin/Volunteer.o bin/Action.o bin/WareHouse.o bin/main.o
